#[starknet::interface]
pub trait IProcessDeactivateStarkWrapper<TContractState> {
...
#[starknet::contract]
pub mod ProcessDeactivateStarkWrapper {
    ...
    #[abi(embed_v0)]
    impl ProcessDeactivateStarkWrapperImpl of super::IProcessDeactivateStarkWrapper<ContractState> {
        ...
        fn get_expected_plain_fact_hash(
            ...
            fact_hash(self.process_deactivate_program_hash.read(), public_output_hash)
        }
        ...
        fn submit_process_deactivate_fact(
            ...
            accept_process_deactivate_fact(
                ref self,
        ...
        fn submit_process_deactivate_atlantic_metadata_fact(
            ...
            assert(
                *metadata_output.at(output_start + 13) == current_state_commitment,
                'STATE_OUTPUT_BAD',
            );
    ...
    fn validate_plain_fact(
        ...
        let expected_fact_hash = fact_hash(
            self.process_deactivate_program_hash.read(), public_output_hash,
        );
    ...
    fn validate_atlantic_metadata_fact(
        ...
        assert(
            *metadata_output.at(4) == self.process_deactivate_program_hash.read(),
            'PROGRAM_MISMATCH',
        );
    ...
    fn accept_process_deactivate_fact(
        ref self: ContractState,
        current_deactivate_commitment: felt252,
        new_deactivate_commitment: felt252,
        current_state_commitment: felt252,
